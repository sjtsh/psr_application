...
class OutletClosedService {
  Future<bool> insertOutletClosed(File file, String name, String userID,
      String remarks, int outletPlanID, BuildContext context) async {
    ...
    if (connection) {
      ...
      await context.read<DataManagement>().insertOutletClosed(OutletClosedEntity(
          file.path,
          name,
          userID,
          remarks,
